...
class TwitterActivity : AppCompatActivity() , SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recycler_view_twitter.adapter = adapter
        recycler_view_twitter.layoutManager = LinearLayoutManager(this)

        val dividerItemDecoration = DividerItemDecoration(this, DividerItemDecoration.VERTICAL)
        recycler_view_twitter.addItemDecoration(dividerItemDecoration)
        // full screen
    ...
    fun searchTweets(){
        ...
        twitterApi.searchForTweets(query, RESULT_TYPE, MAX_TWEETS)?.enqueue(object :
    ...
    fun returnToLogin(view: View){
        finish() // Stops and closes this activity
    }
